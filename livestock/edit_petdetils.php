		...
		<div id="mainact">
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="petowner" placeholder="Enter the LiveStock Owner" value="<?php echo "" . $row['pet_owner'] . ""; ?>"></td>
				</tr>
				<tr>
					<td>Enter LiveStock Birth Date :</td>
					<td><input type="text" name="petbirthplace" placeholder="Enter the LiveStock Birth Place" value="<?php echo "" . $row['pet_birth_place'] . ""; ?>"></td>
				</tr>
				<tr>
					<td>Enter LiveStock Death Place :</td>
					<td><input type="text" name="petdeathplace" placeholder="Enter the LiveStock Death Place" value="<?php echo "" . $row['pet_death_place'] . ""; ?>"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="ownercount" placeholder="Enter the NumberOfOwnersTillNow" value="<?php echo "" . $row['Count_of_Owners'] . ""; ?>"></td>
				</tr>
...
if (isset($_POST['click'])) {
	...
	$query = $con->prepare("update petdetails set pet_name='$petname',pet_type='$pettype',pet_color='$petcolor',pet_Rate='$petrate',pet_keywords='$petkeyword',pet_features1='$petfeature1',pet_features2='$petfeature2',pet_foods='$petfoods',pet_owner='$petowner',pet_birth_place='$petbirthplace',pet_death_place='$petdeathplace',Count_of_Owners='$ownercount' where pet_id='$petid'");
