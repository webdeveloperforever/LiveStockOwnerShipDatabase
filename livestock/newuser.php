	...
	<div class="container-signup">
		...
		<form method="post" enctype="multipart/form-data">
			...
			<center>
				...
				<br><b style="color:#fff;"> Role:</b><select name="role" style="margin-left:40px;" required><option selected>Please select your role</option><option value="Buyer">Buyer</option><option value="Seller">Seller</option></select>
...
if (isset($_POST['submit'])) {
	...
	$pdoResult = $con->prepare("INSERT INTO newuser(username,phoneno,address,city,pincode,role,email,password,user_img) VALUES ('$username','$phone','$address','$city','$pincode','$role','$email','$password','$pro_img1')");
